...
<div class="wrap">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			<h1 class="text-center"><em><a href="http://awplife.com/product/flickr-gallery-premium/">Flickr Gallery Premium Plugin</a></em></h1>
			<h1>"Buy Premium Plugin with More Effects, Column settings , Hover Transition Effects , LightBox Style & Flickr Profile settings etc."</h1>
			
			<div class="thumbnail col-md-5"><br>
				<h2 class="text-center">Responsive Flickr Gallery For All Devices</h2>		
				<img class="" src="<?php echo FG_PLUGIN_URL . 'img/flickr-responsive-image.png' ?>"/>
				<h2 class="text-center"><a class="btn btn-primary btn-lg" href="http://awplife.com/account/signup/flickr-gallery-premium/">Purchase Now</a></h2><br>
			</div>
			<div class="thumbnail col-md-6">
				<img class="" src="<?php echo FG_PLUGIN_URL . 'img/pricing-table.png' ?>"/>
			</div>
				<style>
					.awp_bale_offer {
						background-image: url("<?php echo FG_PLUGIN_URL ?>/img/awp-bale.jpg");
			...
			<div class="col-md-12">
				<div class="row awp_bale_offer text-center">
					<div class="col-md-6">
						<h1>Plugin's Bale Offer - 20+ Plugins</h1>
						<h3>Get All Premium Plugin ( Personal Licence) in just $99 </h3>
						<h3><strike>$269</strike> For $99 Only</h3>
					</div>
					<div class="col-md-6">
				...
				<p class="">
					...
					<a href="https://wordpress.org/plugins/weather-effect/" target="_blank" class="button button-primary load-customize hide-if-no-customize">Weather Effect</a><br><br>

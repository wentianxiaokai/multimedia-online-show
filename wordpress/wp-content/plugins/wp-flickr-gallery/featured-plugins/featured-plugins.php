...
wp_enqueue_style('awl-fg-bootstrap-css', FG_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('awl-fg-smartech-css', FG_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('awl-fg-feature-plugins', FG_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('awl-fg-media-uploads',FG_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('awl-fg-bootstrap-min-js',FG_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');

<?php
/**
 * resi admin functions  
 *
 * @package resi 
 */

// admin area styling
function resi_custom_colors() {
...
add_action('admin_head', 'resi_custom_colors'); 
...
add_action( 'tgmpa_register', 'resi_recommend_plugin' );
function resi_recommend_plugin() {
